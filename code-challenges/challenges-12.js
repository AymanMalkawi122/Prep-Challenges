...
const cvsFiltration = (arr) => {
    let filtered= arr.filter(obj => obj.tech=='JS'&&obj.yearsOfExperience>4);
    return filtered.map(obj =>{return {fullName:obj.firstName.concat(' ',obj.LastName),tech:obj.tech}});
}
// -------------------------------------------------------------------------------------------------------
